...
x = np.array([[69.5,38.5],[77.0,55.5],[78.5,50.8]\
    ,[87.5,65.5],[74.5,49.0],[74.5,45.5],[76.5,51.0]\
    ,[81.5,59.5],[74.5,43.5],[79.0,53.5]])
y = np.array([149.5,162.5,162.7,162.2,156.5,156.1,172.0,173.2,159.5,157.7])
...
# X_train = np.array([[69.5,38.5],[77.0,55.5],[78.5,50.8]\
#     ,[87.5,65.5],[74.5,49.0],[74.5,45.5],[76.5,51.0]\
#     ,[81.5,59.5],[74.5,43.5],[79.0,53.5]])
# y_train = np.array([149.5,162.5,162.7,162.2,156.5,156.1,172.0,173.2,159.5,157.7])
# X_test = X_train
# y_test = y_train
...
class RNN(torch.nn.Module):
    def __init__(self):
        ...
        self.out = torch.nn.Linear(in_features=44, out_features=3)
